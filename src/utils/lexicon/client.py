...
OTHER_MESSAGE = '⛔️ Неизвестная команда! Чтобы посмотреть список доступных команд введите - /help'

STATE_WARNING_MESSAGE = '❗️ Ошибка! Вы находитесь в состоянии заполнения данных'
